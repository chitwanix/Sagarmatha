...
EDITOR_DIALOG_UI_PATH = "/usr/share/sagarmatha/desklets/launcher@sagarmatha.org/editorDialog.ui"
...
class EditorDialog:
    ...
    def on_edit_ok_clicked(self, widget):
        ...
        if self.desklet_id == -1: # Add new launcher
            ...
            enabled_desklets.append("launcher@sagarmatha.org:%s:0:100" % self.desklet_id)
