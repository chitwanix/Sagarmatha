...
const CUSTOM_LAUNCHERS_PATH = GLib.get_home_dir() + '/.sagarmatha/panel-launchers/';
...
MyDesklet.prototype = {
    ...
    _init: function(metadata, desklet_id){
        ...
        this._launcherSettings = new Gio.Settings({schema: 'org.sagarmatha.desklets.launcher'});
        ...
        this._menu.addAction(_("Add new launcher"), function() {
                                 Util.spawnCommandLine("/usr/share/sagarmatha/desklets/launcher@sagarmatha.org/editorDialog.py");
                             });
        this._menu.addAction(_("Edit launcher"), Lang.bind(this, function() {
                                                               Util.spawnCommandLine("/usr/share/sagarmatha/desklets/launcher@sagarmatha.org/editorDialog.py " + this.instance_id);
                                                           }));
    ...
    _getApp: function() {
        ...
        // No desktop file found; Default to 'sagarmatha-settings.desktop'
        return appSys.lookup_app('sagarmatha-settings.desktop');
    },
