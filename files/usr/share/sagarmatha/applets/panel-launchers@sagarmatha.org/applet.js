...
const APPLET_DIR = imports.ui.appletManager._find_applet('panel-launchers@sagarmatha.org');
...
MyApplet.prototype = {
    ...
    showAddLauncherDialog: function(timestamp, launcher){
        if (launcher) {
            ...
            Util.spawnCommandLine("sagarmatha-desktop-editor -mpanel-launcher -f" + launcher.getId());
        } else {
            Util.spawnCommandLine("sagarmatha-desktop-editor -mpanel-launcher");
        }
    },
