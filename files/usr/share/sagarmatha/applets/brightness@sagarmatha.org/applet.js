...
/* constants */
const DimSettingsSchema = "org.sagarmatha.settings-daemon.plugins.power";
const DimSettingsAc = "idle-dim-ac";
const DimSettingsBattery = "idle-dim-battery";
const PowerBusName = 'org.sagarmatha.SettingsDaemon';
const PowerObjectPath = '/org/sagarmatha/SettingsDaemon/Power';

/* DBus interface */
const PowerManagerInterface = {
    name: 'org.sagarmatha.SettingsDaemon.Power.Screen',
    methods:
        [
...
/* TextImageMenuItem taken from sound@sagarmatha.org applet */
let icon_path = "/usr/share/sagarmatha/theme/";
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height) {        
        ...
        try {
            ...
            //this is exactly the same type of label as in sound@sagarmatha.org, it uses the same style.
    ...
    /* taken from a11y@sagarmatha.org */
    ...
    /* end taken from a11y@sagarmatha.org */
