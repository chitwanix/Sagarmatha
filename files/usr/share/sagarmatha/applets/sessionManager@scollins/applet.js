...
let CommandDispatcher = {
    ...
    lock: function() {
        ...
        if ( screensaver_dialog.query_exists(null) ) {
            if ( screensaver_settings.get_boolean("ask-for-away-message") ) Util.spawnCommandLine("sagarmatha-screensaver-lock-dialog");
            else Util.spawnCommandLine("sagarmatha-screensaver-command --lock");
        }
