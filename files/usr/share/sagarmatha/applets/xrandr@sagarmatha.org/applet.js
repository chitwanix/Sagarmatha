...
const SagarmathaDesktop = imports.gi.SagarmathaDesktop;
...
const possibleRotations = [ SagarmathaDesktop.RRRotation.ROTATION_0,
			    SagarmathaDesktop.RRRotation.ROTATION_90,
			    SagarmathaDesktop.RRRotation.ROTATION_180,
			    SagarmathaDesktop.RRRotation.ROTATION_270
			  ];

let rotations = [ [ SagarmathaDesktop.RRRotation.ROTATION_0, N_("Normal") ],
		  [ SagarmathaDesktop.RRRotation.ROTATION_90, N_("Left") ],
		  [ SagarmathaDesktop.RRRotation.ROTATION_270, N_("Right") ],
		  [ SagarmathaDesktop.RRRotation.ROTATION_180, N_("Upside-down") ]
		];

const XRandr2Iface = {
    name: 'org.sagarmatha.SettingsDaemon.XRANDR_2',
    methods: [
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height) {        
        ...
        try {        
            ...
            this._proxy = new XRandr2(DBus.session, 'org.sagarmatha.SettingsDaemon', '/org/sagarmatha/SettingsDaemon/XRANDR');

            try {
                this._screen = new SagarmathaDesktop.RRScreen({ gdk_screen: Gdk.Screen.get_default() });
    ...
    _createMenu: function() {
        let config = SagarmathaDesktop.RRConfig.new_current(this._screen);
        ...
        this.menu.addAction(_("Configure display settings..."), function() {
            GLib.spawn_command_line_async('sagarmatha-settings display');
        });
    },
