...
// Licence: GPLv2+
// http://intgat.tigress.co.uk/rmy/extensions/gnome-Sagarmatha-frippery-0.2.3.tgz
...
const LIST_SCHEMAS = "org.sagarmatha.applets.windowListGroup";
...
//if (FIND_SCHEMA)
    windowListSettings = Convenience.getSettings("org.sagarmatha.applets.windowListGroup");
...
PinnedFavs.prototype = {
    ...
    _addFavorite: function (appId, pos) {
        ...
        let app = Sagarmatha.AppSystem.get_default().lookup_app(appId);
        if (!app) app = Sagarmatha.AppSystem.get_default().lookup_settings_app(appId);
...
AppTracker.prototype = {
    _init: function (tracker) {
        this.tracker = tracker || Sagarmatha.WindowTracker.get_default();
...
AppList.prototype = {
    _init: function (applet, metaWorkspace, orientation) {
        ...
        this._tracker = new AppTracker(Sagarmatha.WindowTracker.get_default());
    ...
    _windowAdded: function (metaWorkspace, metaWindow, favapp, isFavapp) {
        ...
        if (!this._appList.contains(app)) {
            ...
            let appStateSignal = app.connect('notify::state', Lang.bind(this, function (app) {
                if (app.state == Sagarmatha.AppState.STOPPED && this._appList.contains(app)) {
                    this._removeApp(app);
    ...
    _loadFavorites: function () {
        ...
        let launchers = GetAppFavorites().settings.get_strv(GetAppFavorites().FAVORITE_APPS_KEY), appSys = Sagarmatha.AppSystem.get_default();
