...
const KEY_RECORDER_SCHEMA = "org.sagarmatha.recorder";
...
LocalSettings.prototype = {
   ...
   _settingsChanged: function(monitor, fileObj, n, eventType) {
      ...
      try {
         this._settings = JSON.parse(Sagarmatha.get_file_contents_utf8_sync(this._filename));
...
MyApplet.prototype = {
   ...
   /*_onKeybindingChanged: function(key, oldVal, newVal, type, index) {
      Main.keybindingManager.addHotKey(key, newVal, Lang.bind(this, function(e) {
         return this.run_sagarmatha_camera(type, e, index);
      }));
   },*/
   ...
   registerKeyBinding: function(key, captureType, index) {
      ...
      this._bindFns[key] = Lang.bind(this, function() {
         ...
         return this.run_sagarmatha_camera(captureType, null, index);
      });
   ...
   _registerKeyBindings: function() {
      ...
      if (this.has_camera()) {
         if (this.get_camera_program() == 'sagarmatha') {
            ...
            this.registerKeyBinding('kb-cs-ui', Screenshot.SelectionType.SAGARMATHA);
            ...
            this.settings.connect("changed::kb-cs-ui", Lang.bind(this. this._onKeybindingChanged,
              Screenshot.SelectionType.SAGARMATHA));
   ...
   _settingsChanged: function(key) {
    ...
    _crSettingsChanged: function(settings, key) {
        if (this._recorderProgram == 'sagarmatha')
        {
           this.cRecorder = new Sagarmatha.Recorder({ stage: global.stage });
        }
   ...
   _init: function(metadata, orientation, panelHeight, instanceId) {
      ...
      try {
         ...
         try {
            this._programSupport = JSON.parse(Sagarmatha.get_file_contents_utf8_sync(supportFile));
         }
         catch (e) {
         ...
         let xfixesCursor = Sagarmatha.XFixesCursor.get_for_stage(global.stage);
   ...
   draw_menu: function(orientation) {
      ...
      if (this.has_camera()) {
         ...
         if (this.get_camera_program() == 'sagarmatha') {
            this.menu.addAction(this.indent(_("Window")), Lang.bind(this, function(e) {
               return this.run_sagarmatha_camera(Screenshot.SelectionType.WINDOW, e);
            }));
            this.menu.addAction(this.indent(_("Area")), Lang.bind(this, function(e) {
               return this.run_sagarmatha_camera(Screenshot.SelectionType.AREA, e);
            }));
            this.menu.addAction(this.indent(_("Sagarmatha UI")), Lang.bind(this, function(e) {
               return this.run_sagarmatha_camera(Screenshot.SelectionType.SAGARMATHA, e);
            }));
            this.menu.addAction(this.indent(_("Screen")), Lang.bind(this, function(e) {
               return this.run_sagarmatha_camera(Screenshot.SelectionType.SCREEN, e);
            }));
               ...
               Main.layoutManager.monitors.forEach(function(monitor, index) {
                  this.menu.addAction(this.indent(_("Monitor %d").format(index + 1)), 
                   Lang.bind(this, function(e) {
                     return this.run_sagarmatha_camera(Screenshot.SelectionType.MONITOR, e, index);
                  }));
                }, this);
            }

            this.menu.addAction(this.indent(_("Interactive")), Lang.bind(this, function(e) {
               return this.run_sagarmatha_camera(Screenshot.SelectionType.INTERACTIVE, e);
            }));
            this._redoMenuItem = this.menu.addAction(this.indent(_("Redo last")), Lang.bind(this, this.redo_sagarmatha_camera));
      ...
      if (this.has_recorder())
      {
         ...
         if (this.get_recorder_program() == 'sagarmatha')
         {
             this._cRecorderItem = this.menu.addAction(this.indent(_("Start recording")), Lang.bind(this, this._toggle_sagarmatha_recorder));
             ...
             // ignore it.
             //global.screen.connect('toggle-recording', Lang.bind(this, this._update_sagarmatha_recorder_status));
         }
         else
         {
   ...
   redo_sagarmatha_camera: function(event) {
      if (this.lastCapture) {
         ...
         switch (this.lastCapture.selectionType) {
            ...
            case Screenshot.SelectionType.AREA:
               camera.screenshotArea(
                  ...
                  this.lastCapture.options);
               break;
            case Screenshot.SelectionType.SAGARMATHA:
               camera.screenshotSagarmatha(
   ...
   sagarmatha_camera_complete: function(screenshot) {
   ...
   run_sagarmatha_camera: function(type, event, index) {
      let enableTimer = (this._useTimer && this._delay > 0);

      let fnCapture = Lang.bind(this, function() {
         new Screenshot.ScreenshotHelper(type, Lang.bind(this, this.sagarmatha_camera_complete),
         { 
   ...
   _update_sagarmatha_recorder_status: function(actor) {
   ...
   _toggle_sagarmatha_recorder: function(actor, event) {
      if (this.cRecorder.is_recording()) {
      ...
      this._update_sagarmatha_recorder_status(actor);
   },
   ...
   _launch_settings: function() {
      if (this._localSettings) {
         ...
         Main.Util.spawnCommandLine('sagarmatha-settings applets '+this._uuid);
      }
   },
   ...
   onProcessComplete: function(status, stdout) {
      ...
      // @future Check status when we're able to (depends on Sagarmatha)
   ...
   detect_programs: function() {
      ...
      if (!this.get_program_available(this._recorderProgram)
          && this._recorderProgram != 'sagarmatha')
      {
         this._recorderProgram = null;
