...
'''
Settings app for Sagarmatha Desktop Capture applet
...
class MyWindow(Gtk.Window):
    ...
    def maybe_show_tabs(self):
        if self.cameraApp != "sagarmatha" and self.recorderApp != "sagarmatha":
    ...
    def __init__(self):
        ...
        if self.recorderApp != "sagarmatha":
           self.set_recorder_tab(False)
...
if __name__ == "__main__":
    ...
    crSettings = Gio.Settings.new('org.sagarmatha.recorder')
