...
const Gettext = imports.gettext.domain('sagarmatha-extensions');
const _ = Gettext.gettext;
const Util = imports.misc.util;
const Lang = imports.lang; 
const GLib = imports.gi.GLib;
const Gio = imports.gi.Gio;
const AppletMeta = imports.ui.appletManager.applets['xampp-panel@sagarmatha.org'];
const AppletDir = imports.ui.appletManager.appletMeta['xampp-panel@sagarmatha.org'].path;
