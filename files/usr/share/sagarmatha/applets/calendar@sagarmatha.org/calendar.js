...
// in org.sagarmatha.desktop.interface
...
const CalendarServerIface = {
    name: 'org.Sagarmatha.CalendarServer',
...
CalendarServer.prototype = {
     _init: function() {
         DBus.session.proxifyObject(this, 'org.Sagarmatha.CalendarServer', '/org/Sagarmatha/CalendarServer');
     }
};
...
DBusEventSource.prototype = {
    _init: function(owner) {
        ...
        DBus.session.watch_name('org.Sagarmatha.CalendarServer',
...
Calendar.prototype = {
    _init: function(eventSource, settings) {
        ...
        this._weekStart = Sagarmatha.util_get_week_start();
        this._weekdate = NaN;
    ...
    _update: function(forceReload) {
        ...
        while (true) {
            ...
            // Hack used in lieu of border-collapse - see sagarmatha.css
            if (row == 2)
...
EventsList.prototype = {
    _init: function(eventSource) {
        ...
        this._desktopSettings = new Gio.Settings({ schema: 'org.sagarmatha.desktop.interface' });
