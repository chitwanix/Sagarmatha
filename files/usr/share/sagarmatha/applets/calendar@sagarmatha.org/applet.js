...
const AppletDir = imports.ui.appletManager.applets['calendar@sagarmatha.org'];
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {        
        ...
        try {                 
            ...
            this.settings = new Settings.AppletSettings(this, "calendar@sagarmatha.org", this.instance_id);
    ...
    _onLaunchSettings: function() {
        this.menu.close();
        Util.spawnCommandLine("sagarmatha-settings calendar");
    },
