...
const AppletDir = imports.ui.appletManager.appletMeta['sports-update@sagarmatha.org'].path;
const AppletMeta = imports.ui.appletManager.applets['sports-update@sagarmatha.org'];
...
const conf_script = GLib.build_filenamev([global.userdatadir, 'applets/sports-update@sagarmatha.org/settings.js']);

/*------------------------
 * Constants
 * ------------------------*/

const UUID = 'sports-update@sagarmatha.org';
...
const CMD_SETTINGS = "sagarmatha-settings applets " + UUID;
