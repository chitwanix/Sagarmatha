...
LiveScore.prototype.parseResponse = function(response){
	...
	try {
		...
		global.log("sports-update@sagarmatha.org : Error parsing score updates "  + e);
		return scorelist;
	}	 
}
...
LiveScore.prototype.parseCricketResponse = function(response, sport){
	...
	try{		
		...
		global.log("sports-update@sagarmatha.org : Error parsing cricket updates "  + e);	
	}	
}
...
LiveScore.prototype.getCricketScoreDetails = function(matchIds){
	try{	
		...
		*/	
		...
		global.log("sports-update@sagarmatha.org : Error fetching cricket updates "  + e);		
	}	
}
...
LiveScore.prototype.onCricketHandleResponse = function(session,message){
	...
	try{	
		...
		global.log("sports-update@sagarmatha.org : Error parsing cricket scores "  + e);		
	}
