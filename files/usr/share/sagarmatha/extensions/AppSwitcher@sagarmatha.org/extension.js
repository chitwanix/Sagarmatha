/* Sagarmatha extension to switch between running apps by <Super>Tab
 ...
 * With code derived from the default Sagarmatha AltTab.
...
const UUID = "AppSwitcher@sagarmatha.org";
...
appSwitcherSettings = new Gio.Settings ( {schema_id: "org.sagarmatha.muffin.keybindings"} );
...
AppSwitcher3D.prototype = {
  ...
  _keyPressEvent : function (actor, event) {
    ...
    let event_state = Sagarmatha.get_event_state (event);     
...
TimelineSwitcher.prototype = {
  ...
  _activateSelectedApp : function () {
    ...
    if (app == null)
    {
      app = Sagarmatha.WindowTracker.get_default ().get_window_app (win);
    }
...
IconLabelButton.prototype = {
  ...
  _init : function (icon) {
    ...
    //in a Sagarmatha.GenericContainer
    ...
    this._iconBox = new Sagarmatha.Slicer ( {
        name: 'appBoxIcon'
    });
...
AppBox.prototype = {
  ...
  _init : function (app) {
    ...
    this.app = app;
    this.numWindows = 0;
    this.actor = new Sagarmatha.GenericContainer ();
...
function init() {
  ...
  appSys = Sagarmatha.AppSystem.get_default ();
}
