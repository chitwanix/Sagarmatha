...
CUSTOM_KEYS_PARENT_SCHEMA = "org.sagarmatha.keybindings"
CUSTOM_KEYS_BASENAME = "/org/sagarmatha/keybindings/custom-keybindings"
CUSTOM_KEYS_SCHEMA = "org.sagarmatha.keybindings.custom-keybinding"

MUFFIN_KEYBINDINGS_SCHEMA = "org.sagarmatha.muffin.keybindings"
MEDIA_KEYS_SCHEMA = "org.sagarmatha.settings-daemon.plugins.media-keys"
...
KEYBINDINGS = [
    ...
    # Sagarmatha stuff
    [_("Toggle Scale"), MUFFIN_KEYBINDINGS_SCHEMA, "switch-to-workspace-down", True, "sagarmatha"],
    [_("Toggle Expo"), MUFFIN_KEYBINDINGS_SCHEMA, "switch-to-workspace-up", True, "sagarmatha"],
    [_("Cycle through open windows"), MUFFIN_KEYBINDINGS_SCHEMA, "switch-windows", True, "sagarmatha"],
    [_("Cycle backwards though open windows"), MUFFIN_KEYBINDINGS_SCHEMA, "switch-windows-backward", True, "sagarmatha"],
    [_("Run dialog"), MUFFIN_KEYBINDINGS_SCHEMA, "panel-run-dialog", True, "sagarmatha"],
    [_("Menu button (must restart Sagarmatha)"), "org.sagarmatha.muffin", "overlay-key", False, "sagarmatha"],
    ...
    [_("Toggle recording desktop (must restart Sagarmatha)"), MUFFIN_KEYBINDINGS_SCHEMA, "toggle-recording", True, "system"],
...
class CustomKeyBinding():
    ...
    def writeSettings(self):
        ...
        # Touch the custom-list key, this will trigger a rebuild in sagarmatha
...
class KeyboardSidePage (SidePage):
    ...
    def build(self, advanced):
        ...
        tab.add_widget(GSettingsCheckButton(_("Enable key repeat"), "org.sagarmatha.settings-daemon.peripherals.keyboard", "repeat", None))
        box = IndentedHBox()
        slider = GSettingsRange(_("Repeat delay:"), _("Short"), _("Long"), 100, 2000, False, "uint", False, "org.sagarmatha.settings-daemon.peripherals.keyboard", "delay",
                                                                        "org.sagarmatha.settings-daemon.peripherals.keyboard/repeat", adjustment_step = 10)
        box.pack_start(slider, True, True, 0)
        tab.add_widget(box)
        box = IndentedHBox()
        slider = GSettingsRange(_("Repeat speed:"), _("Slow"), _("Fast"), 20, 2000, True, "uint", True, "org.sagarmatha.settings-daemon.peripherals.keyboard", "repeat-interval",
                                                                        "org.sagarmatha.settings-daemon.peripherals.keyboard/repeat", adjustment_step = 1)
        box.pack_start(slider, True, True, 0)
        tab.add_widget(box)
        tab.add_widget(Gtk.Separator.new(Gtk.Orientation.HORIZONTAL))
        
        tab.add_widget(GSettingsCheckButton(_("Text cursor blinks"), "org.sagarmatha.desktop.interface", "cursor-blink", None))
        box = IndentedHBox()
        slider = GSettingsRange(_("Blink speed:"), _("Slow"), _("Fast"), 100, 2500, True, "int", False, "org.sagarmatha.desktop.interface", "cursor-blink-time",
                                                                        "org.sagarmatha.desktop.interface/cursor-blink", adjustment_step = 10)
        box.pack_start(slider, True, True, 0)
        tab.add_widget(box)
        tab.add_widget(Gtk.Separator.new(Gtk.Orientation.HORIZONTAL))
        ...
        self.main_store.append(KeyBindingCategory("Sagarmatha", "sagarmatha"))
