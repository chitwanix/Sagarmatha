...
class DateTimeWrapper:
    def __init__(self):
        try:
            ...
            proxy = dbus.SystemBus().get_object("org.sagarmatha.SettingsDaemon.DateTimeMechanism", "/")
            self.dbus_iface = dbus.Interface(proxy, dbus_interface="org.sagarmatha.SettingsDaemon.DateTimeMechanism")
