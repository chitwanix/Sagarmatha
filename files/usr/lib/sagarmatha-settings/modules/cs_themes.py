...
class Module:
    def __init__(self, content_box):
        ...
        noun = _("theme")
        pl_noun = _("themes")
        # We do not translate Sagarmatha
        target = "Sagarmatha"
...
class ThemesViewSidePage (ExtensionSidePage):
    ...
    def getAdditionalPage(self):
        ...
        gtkThemeSwitcher = GSettingsComboBox(_("Controls"), "org.sagarmatha.desktop.interface", "gtk-theme", None, self._load_gtk_themes())
        other_settings_box.pack_start(gtkThemeSwitcher, False, False, 2)
        
        iconThemeSwitcher = GSettingsComboBox(_("Icons"), "org.sagarmatha.desktop.interface", "icon-theme", None, self._load_icon_themes())
        other_settings_box.pack_start(iconThemeSwitcher, False, False, 2)            
        
        windowThemeSwitcher = GSettingsComboBox(_("Window borders"), "org.sagarmatha.desktop.wm.preferences", "theme", None, self._load_window_themes())
        other_settings_box.pack_start(windowThemeSwitcher, False, False, 2)
                
        cursorThemeSwitcher = GSettingsComboBox(_("Mouse pointer"), "org.sagarmatha.desktop.interface", "cursor-theme", None, self._load_cursor_themes())
        other_settings_box.pack_start(cursorThemeSwitcher, False, False, 2)
        
        keybindingThemeSwitcher = GSettingsComboBox(_("Keybindings"), "org.sagarmatha.desktop.interface", "gtk-key-theme", None, self._load_keybinding_themes())
        other_settings_box.pack_start(keybindingThemeSwitcher, False, False, 2)            

        menusHaveIconsCB = GSettingsCheckButton(_("Show icons in menus"), "org.sagarmatha.settings-daemon.plugins.xsettings", "menus-have-icons", None)
        other_settings_box.pack_start(menusHaveIconsCB, False, False, 2)

        buttonsHaveIconsCB = GSettingsCheckButton(_("Show icons on buttons"), "org.sagarmatha.settings-daemon.plugins.xsettings", "buttons-have-icons", None)
