...
class DeskletsViewSidePage (ExtensionSidePage):
    ...
    def getAdditionalPage(self):
        ...
        dec_combo = GSettingsIntComboBox(_("Decoration of desklets"), "org.sagarmatha", "desklet-decorations", dec)
        ...
        desklet_snap = GSettingsCheckButton(_("Snap desklets to grid"), "org.sagarmatha", "desklet-snap", None)
        desklet_snap_interval = GSettingsSpinButton(_("Width of desklet snap grid"), "org.sagarmatha", "desklet-snap-interval", "org.sagarmatha/desklet-snap", 0, 100, 1, 5, "")
