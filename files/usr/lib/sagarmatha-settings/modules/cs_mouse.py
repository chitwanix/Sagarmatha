...
class MouseTouchpadSidepage (SidePage):
    def __init__(self, name, icon, keywords, advanced, content_box):
        ...
        box = IndentedHBox()
        box.add(CheckButton(_("Left handed (mouse buttons inverted)"), "org.sagarmatha.settings-daemon.peripherals.mouse", "left-handed", None))
        self.add_widget(box, 0)

        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Show position of pointer when the Control key is pressed"), "org.sagarmatha.settings-daemon.peripherals.mouse", "locate-pointer", None))
        self.add_widget(box, 0)

        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Emulate middle click by clicking both left and right buttons"), "org.sagarmatha.settings-daemon.peripherals.mouse", "middle-button-enabled", None))
        ...
        box = IndentedHBox()
        slider = GSettingsRange(_("Acceleration:"), _("Slow"), _("Fast"), 1.0, 10.0, False, "double", False, "org.sagarmatha.settings-daemon.peripherals.mouse", "motion-acceleration", None, adjustment_step = 1.0)
        box.add_expand(slider)
        self.add_widget(box, 0, None)

        box = IndentedHBox()
        slider = GSettingsRange(_("Sensitivity:"), _("Low"), _("High"), 1, 10, False, "int", False, "org.sagarmatha.settings-daemon.peripherals.mouse", "motion-threshold", None, adjustment_step = 1)
        box.add_expand(slider)
        self.add_widget(box, 0, None) 
        ...
        box = IndentedHBox()
        slider = GSettingsRange(_("Timeout:"), _("Short"), _("Long"), 100, 1000, False, "int", False, "org.sagarmatha.settings-daemon.peripherals.mouse", "double-click", None, adjustment_step = 1)
        box.add_expand(slider)
        self.add_widget(box, 0, None)
        ...
        box = IndentedHBox()
        box.add(GSettingsSpinButton(_("Sagarmatha drag threshold"), "org.sagarmatha", "dnd-drag-threshold", None, 1, 400, 1, 1, _("Pixels")))
        self.add_widget(box, 0, True)

        box = IndentedHBox()
        box.add(GSettingsSpinButton(_("GTK drag threshold"), "org.sagarmatha.settings-daemon.peripherals.mouse", "drag-threshold", None, 1, 400, 1, 1, _("Pixels")))
        self.add_widget(box, 0, True)
        ...
        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Enable touchpad"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "touchpad-enabled", None))
        self.add_widget(box, 1)

        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Disable touchpad while typing"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "disable-while-typing", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled"))
        self.add_widget(box, 1)
        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Enable mouseclicks with touchpad"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "tap-to-click", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled"))
        self.add_widget(box, 1)
        ...
        scroll_method_combo = GSettingsComboBox(_("Panel layout"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "scroll-method", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled", scroll_method)
        box = IndentedHBox()
        box.add(scroll_method_combo)
        self.add_widget(box, 1)
        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Enable natural scrolling"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "natural-scroll", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled"))
        self.add_widget(box, 1)
        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Enable horizontal scrolling"), "org.sagarmatha.settings-daemon.peripherals.touchpad", "horiz-scroll-enabled", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled"))
        self.add_widget(box, 1)
        ...
        slider = GSettingsRange(_("Acceleration:"), _("Slow"), _("Fast"), 1.0, 10.0, False, "double", False, "org.sagarmatha.settings-daemon.peripherals.touchpad", "motion-acceleration", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled", adjustment_step = 1.0)
        box = IndentedHBox()
        box.add_expand(slider)
        self.add_widget(box, 1, None)

        slider = GSettingsRange(_("Sensitivity:"), _("Low"), _("High"), 1, 10, False, "int", False, "org.sagarmatha.settings-daemon.peripherals.touchpad", "motion-threshold", "org.sagarmatha.settings-daemon.peripherals.touchpad/touchpad-enabled", adjustment_step = 1)
        box = IndentedHBox()
        box.add_expand(slider)
        self.add_widget(box, 1, None) 
