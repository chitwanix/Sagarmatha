...
class Module:
    def __init__(self, content_box):
        ...
        sidePage.add_widget(GSettingsCheckButton(_("Enable desktop effects"), "org.sagarmatha", "desktop-effects", None))

        box = IndentedHBox()
        box.add(GSettingsCheckButton(_("Enable desktop effects on dialog boxes"), "org.sagarmatha", "desktop-effects-on-dialogs", "org.sagarmatha/desktop-effects"))
        ...
        def _make_effect_group(group_label, key, effects):
            ...
            root = "org.sagarmatha"
            path = "org.sagarmatha/desktop-effects"
        ...
        sidePage.add_widget(GSettingsCheckButton(_("Enable fade effect on Sagarmatha scrollboxes (like the Menu application list)"), "org.sagarmatha", "enable-vfade", None))
