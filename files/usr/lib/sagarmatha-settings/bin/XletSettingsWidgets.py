    ...
    def __init__(self, file_name, factory, instance_id, multi_instance, uuid):
        ...
        try:
            ...
            try:
                ...
                try:
                    self.t = gettext.translation("sagarmatha", "/usr/share/sagarmatha/locale").ugettext
                except IOError:
                    self.t = None
        self.reload()
...
class Button(Gtk.Button, BaseWidget):
    ...
    def on_clicked(self, widget):
        ...
        sagarmatha_dbus = session_bus.get_object("org.Sagarmatha", "/org/Sagarmatha")
        activate_cb = sagarmatha_dbus.get_dbus_method('activateCallback', 'org.Sagarmatha')
