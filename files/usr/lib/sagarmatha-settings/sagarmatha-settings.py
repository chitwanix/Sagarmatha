...
try:
    sys.path.append('/usr/lib/sagarmatha-settings/modules')
...
# Standard setting pages... this can be expanded to include applet dirs maybe?
    mod_files = glob.glob('/usr/lib/sagarmatha-settings/modules/*.py')
    mod_files.sort()
...
ADVANCED_GSETTING = "sagarmatha-settings-advanced"
...
#         Label                          Executable                          Icon                Category        Advanced?               Keywords for filter
    ...
    [_("Startup Programs"),              "sagarmatha-session-properties",  "startup-programs.svg","prefs",          False,          _("startup, programs, boot, init, session")],
    [_("Device Drivers"),                "chitwanixdrivers",                  "drivers.svg",         "admin",          False,          _("video, driver, wifi, card, hardware, proprietary, nvidia, radeon, nouveau, fglrx")],
    [_("Software Sources"),              "chitwanixsources",                  "sources.svg",         "admin",          True,           _("ppa, repository, package, source, download")],
    [_("Users and Groups"),              "sagarmatha-settings-users",      "user-accounts.svg",   "admin",          True,           _("user, users, account, accounts, group, groups, password")]
]
...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file("/usr/lib/sagarmatha-settings/sagarmatha-settings.ui")
            ...
            if not self.store.has_key(sp_cat):  #       Label         Icon          sidePage     Category
                ...
                for category in CATEGORIES:
                    if category["id"] == sp_cat:
                        category["show"] = True
            iconFile = "/usr/lib/sagarmatha-settings/data/icons/%s" % sp.icon
    ...
    def prepCategory(self, category):
        ...
        iconFile = "/usr/lib/sagarmatha-settings/data/icons/%s" % category["icon"]
        if os.path.exists(iconFile):
