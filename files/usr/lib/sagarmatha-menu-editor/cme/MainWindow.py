...
class MainWindow(object):
    ...
    def __init__(self, datadir, version):
        ...
        self.tree.add_from_file('/usr/lib/sagarmatha-menu-editor/sagarmatha-menu-editor.ui')
    ...
    def on_new_menu_button_clicked(self, button):
        ...
        process = subprocess.Popen(['sagarmatha-desktop-editor', '-mdirectory', '-o' + file_path], env=os.environ)
    ...
    def on_new_item_button_clicked(self, button):
        ...
        process = subprocess.Popen(['sagarmatha-desktop-editor', '-mlauncher', '-o' + file_path], env=os.environ)
    ...
    def on_edit_properties_activate(self, menu):
        ...
        if file_path not in self.edit_pool:
            ...
            process = subprocess.Popen(['sagarmatha-desktop-editor', '-m' + file_type, '-o' + file_path], env=os.environ)
