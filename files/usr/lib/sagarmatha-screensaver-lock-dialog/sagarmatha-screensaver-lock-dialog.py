...
class MainWindow:
    ...
    def __init__(self):
        ...
        gladefile = "/usr/lib/sagarmatha-screensaver-lock-dialog/sagarmatha-screensaver-lock-dialog.glade"
        ...
        self.window.set_icon_from_file("/usr/lib/sagarmatha-settings/data/icons/screensaver.svg")
    ...
    def lock_screen(self, data):
        ...
        if (message != ""):
            os.system("sagarmatha-screensaver-command --lock --away-message \"%s\" &" % self.entry.get_text())
        else:
            os.system("sagarmatha-screensaver-command --lock &")
        gtk.main_quit()
