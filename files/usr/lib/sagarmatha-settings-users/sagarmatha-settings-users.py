...
class Module:
    def __init__(self):
        try:
            ...
            self.builder.add_from_file("/usr/lib/sagarmatha-settings-users/sagarmatha-settings-users.ui")
            ...
            self.face_image.set_from_file("/usr/share/sagarmatha/faces/user-generic.png")      
    ...
    def load_users(self):       
        ...
        for user in users:
            if os.path.exists(user.get_icon_file()):
                ...
                pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size("/usr/share/sagarmatha/faces/user-generic.png", 48, 48)
