...
ModalDialog.prototype = {
    _init: function(params) {
        params = Params.parse(params, { sagarmathaReactive: false,
                                        styleClass: null });

        this.state = State.CLOSED;
        this._hasModal = false;
        this._sagarmathaReactive = params.sagarmathaReactive;
        ...
        if (!this._sagarmathaReactive) {
            this._lightbox = new Lightbox.Lightbox(this._group,
                                                   { inhibitEvents: true });
            this._lightbox.highlight(this._backgroundBin);

            let stack = new Sagarmatha.Stack();
    ...
    _onKeyPressEvent: function(object, keyPressEvent) {
        let modifiers = Sagarmatha.get_event_state(keyPressEvent);
