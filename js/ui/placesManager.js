...
PlacesManager.prototype = {
    _init: function() {
        ...
        let homeLabel = Sagarmatha.util_get_label_for_uri (homeUri);
        let homeIcon = Sagarmatha.util_get_icon_for_uri (homeUri);
        ...
        let desktopLabel = Sagarmatha.util_get_label_for_uri (desktopUri);
        let desktopIcon = Sagarmatha.util_get_icon_for_uri (desktopUri);
    ...
    _reloadBookmarks: function() {
        ...
        let bookmarksContent = Sagarmatha.get_file_contents_utf8_sync(this._bookmarksPath);
        ...
        for (let i = 0; i < bookmarksOrder.length; i++) {
            ...
            if (label == null)
                label = Sagarmatha.util_get_label_for_uri(bookmark);
            if (label == null)
                continue;
            
            let item; 
            if (file.query_exists(null)) {
                let icon = Sagarmatha.util_get_icon_for_uri(bookmark);
