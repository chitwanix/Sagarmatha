...
Applet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        this._order = 0; // Defined in gsettings, this is the order of the applet within a panel location. This value is set by Sagarmatha when loading/listening_to gsettings.
        this._newOrder = null; //  Used when moving an applet
        this._panelLocation = null; // Backlink to the panel location our applet is in, set by Sagarmatha.
        ...
        this._uuid = null; // Defined in gsettings, set by Sagarmatha.
        ...
        if (!this._meta["hide-configuration"] && GLib.file_test(this._meta["path"] + "/settings-schema.json", GLib.FileTest.EXISTS)) {     
            if (this.context_menu_item_configure == null) {            
                this.context_menu_item_configure = new MenuItem(_("Configure..."), Gtk.STOCK_PREFERENCES, Lang.bind(this, function() {
                    Util.spawnCommandLine("sagarmatha-settings applets " + this._uuid + " " + this.instance_id)
                }));
            }
