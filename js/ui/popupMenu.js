...
PopupBaseMenuItem.prototype = {
    _init: function (params) {
        ...
        this.actor = new Sagarmatha.GenericContainer({ style_class: 'popup-menu-item',
...
PopupMenuBase.prototype = {
    ...
    addSettingsAction: function(title, module) {		
        let menuItem = this.addAction(title, function() {
                           Util.spawnCommandLine("sagarmatha-settings " + module);
                       });
        return menuItem;
    },
...
PopupMenu.prototype = {
    ...
    _init: function(sourceActor, arrowAlignment, arrowSide) {
        ...
        this._boxWrapper = new Sagarmatha.GenericContainer();
...
PopupComboBoxMenuItem.prototype = {
    ...
    _init: function (params) {
        ...
        this._itemBox = new Sagarmatha.Stack();
    ...
    _onMenuOpenState: function(menu, open) {
        ...
        if (open) {
            ...
            if (this._grabbedFromKeynav) {
                if (this._preGrabInputMode == Sagarmatha.StageInputMode.FOCUSED)
                    global.stage_input_mode = Sagarmatha.StageInputMode.FOCUSED;
