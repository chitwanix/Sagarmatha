...
const LG_SERVICE_NAME = 'org.Sagarmatha.LookingGlass';
const LG_SERVICE_PATH = '/org/Sagarmatha/LookingGlass';
...
function SagarmathaLookingGlass() {
    this._init();
}

SagarmathaLookingGlass.prototype = {
    _init: function() {
