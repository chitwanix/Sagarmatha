...
const SagarmathaEntry = imports.ui.sagarmathaEntry;
...
const LOCKDOWN_SCHEMA = 'org.sagarmatha.desktop.lockdown';
const DISABLE_COMMAND_LINE_KEY = 'disable-command-line';

const TERMINAL_SCHEMA = 'org.sagarmatha.desktop.default-applications.terminal';
const EXEC_KEY = 'exec';
...
__proto__: ModalDialog.ModalDialog.prototype,
    _init : function() {
        ...
        SagarmathaEntry.addContextMenu(entry);
        ...
        this._entryText.connect('key-press-event', Lang.bind(this, function(o, e) {
            ...
            if (symbol == Clutter.Return || symbol == Clutter.KP_Enter) {
                this.popModal();
                if (Sagarmatha.get_event_state(e) & Clutter.ModifierType.CONTROL_MASK)
