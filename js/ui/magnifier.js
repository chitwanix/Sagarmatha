...
// Settings
const APPLICATIONS_SCHEMA       = 'org.sagarmatha.desktop.a11y.applications';
const SHOW_KEY                  = 'screen-magnifier-enabled';

const MAGNIFIER_SCHEMA          = 'org.sagarmatha.desktop.a11y.magnifier';
...
Magnifier.prototype = {
    _init: function() {
        ...
        // Export to dbus.
        magDBusService = new MagnifierDBus.SagarmathaMagnifier();
...
ZoomRegion.prototype = {
    ...
    _createActors: function() {
        ...
        Sagarmatha.util_set_hidden_from_pick (this._magView, true);
