...
function _getTweenState(target) {
    ...
    if (!target.__SagarmathaTweenerState)
        _resetTweenState(target);
    return target.__SagarmathaTweenerState;
}

function _resetTweenState(target) {
    let state = target.__SagarmathaTweenerState;
    ...
    target.__SagarmathaTweenerState = {};
}
...
ClutterFrameTicker.prototype = {
    ...
    _init : function() {
        ...
        let perf_log = Sagarmatha.PerfLog.get_default();
