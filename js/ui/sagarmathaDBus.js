...
Sagarmatha.prototype = {
    _init: function() {
        DBus.session.exportObject('/org/Sagarmatha', this);
    },
    ...
    SagarmathaVersion: Config.PACKAGE_VERSION
};

DBus.conformExport(Sagarmatha.prototype, SagarmathaIface);
