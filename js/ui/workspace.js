...
const BUTTON_LAYOUT_SCHEMA = 'org.sagarmatha.muffin';
...
WindowClone.prototype = {
    _init : function(realWindow, myContainer) {
        ...
        Sagarmatha.util_set_hidden_from_pick(this.clone, true);
...
WindowOverlay.prototype = {
    ...
    _onStyleChanged: function() {
        ...
        this.title._spacing = titleNode.get_length('-sagarmatha-caption-spacing');

        let closeNode = this.closeButton.get_theme_node();
        this.closeButton._overlap = closeNode.get_length('-sagarmatha-close-overlap');
