...
const DRAG_CURSOR_MAP = {
    0: Sagarmatha.Cursor.DND_UNSUPPORTED_TARGET,
    1: Sagarmatha.Cursor.DND_COPY,
    2: Sagarmatha.Cursor.DND_MOVE
};
...
_Draggable.prototype = {
    ...
    startDrag: function (stageX, stageY, time) {
        ...
        if (this._onEventId)
            this._ungrabActor();
        this._grabEvents();
        global.set_cursor(Sagarmatha.Cursor.DND_IN_DRAG);
        ...
        Sagarmatha.util_set_hidden_from_pick(this._dragActor, true);
    ...
    _dragComplete: function() {
        ...
        if (!this._actorDestroyed && this._dragActor)
            Sagarmatha.util_set_hidden_from_pick(this._dragActor, false);
...
GenericDragItemContainer.prototype = {
    _init: function() {
        this.actor = new Sagarmatha.GenericContainer({ style_class: 'drag-item-container' });
