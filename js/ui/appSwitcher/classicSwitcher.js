...
ClassicSwitcher.prototype = {
    ...
    _init: function() {
        ...
        this.actor = new Sagarmatha.GenericContainer({ name: 'altTabPopup',
                                                  reactive: true,
                                                  visible: false });
...
SwitcherList.prototype = {
    _init : function(squareItems, activeMonitor) {
        this.actor = new Sagarmatha.GenericContainer({ style_class: 'switcher-list' });
        this.actor.connect('get-preferred-width', Lang.bind(this, this._getPreferredWidth));
        this.actor.connect('get-preferred-height', Lang.bind(this, this._getPreferredHeight));
        ...
        this._list = new Sagarmatha.GenericContainer({ style_class: 'switcher-list-item-container' });
