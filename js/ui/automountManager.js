...
const SagarmathaMountOperation = imports.ui.sagarmathaMountOperation;
const ScreenSaver = imports.misc.screenSaver;

// GSettings keys
const SETTINGS_SCHEMA = 'org.sagarmatha.desktop.media-handling';
...
AutomountManager.prototype = {
    ...
    _checkAndMountVolume: function(volume, params) {
        ...
        if (params.useMountOp) {
            let operation = new SagarmathaMountOperation.SagarmathaMountOperation(volume);
    ...
    _reaskPassword: function(volume) {
        let operation = new SagarmathaMountOperation.SagarmathaMountOperation(volume, { reaskPassword: true });
        this._mountVolume(volume, operation.mountOp);        
    },
