...
ConfirmDialog.prototype = {
	...
	this.setButtons([
		...
		action: Lang.bind(this, function(){
                    Util.spawnCommandLine("gsettings reset-recursively org.sagarmatha");
                    global.reexec_self();
		})
	    },
	    {
...
SettingsLauncher.prototype = {
    ...
    activate: function (event) {
        ...
        Util.spawnCommandLine("sagarmatha-settings " + this._keyword);
        return true;
    }
...
function populateSettingsMenu(menu) {
    ...
    */
    ...
    menu.troubleshootItem.menu.addAction(_("Restart Sagarmatha"), function(event) {
        global.reexec_self();
    });
...
Panel.prototype = {
    _init : function(bottomPosition, isPrimary) {
        ...
        Gtk.IconTheme.get_default().append_search_path("/usr/lib/sagarmatha-settings/data/icons/");
        ...
        this.actor = new Sagarmatha.GenericContainer({ name: 'panel',
                                                  reactive: true });
        ...
        this._status_area_sagarmatha_implementation = {};
