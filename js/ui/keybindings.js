...
const CSD_DBUS_NAME = "org.sagarmatha.SettingsDaemon";
const CSD_DBUS_PATH = "/org/sagarmatha/SettingsDaemon/KeybindingHandler";

const CUSTOM_KEYS_PARENT_SCHEMA = "org.sagarmatha.keybindings";
const CUSTOM_KEYS_BASENAME = "/org/sagarmatha/keybindings/custom-keybindings";
const CUSTOM_KEYS_SCHEMA = "org.sagarmatha.keybindings.custom-keybinding";

const MEDIA_KEYS_SCHEMA = "org.sagarmatha.settings-daemon.plugins.media-keys"

/* Enums and gsettings key names - enums for ref, to match up with
   sagarmatha-settings-daemon shortcuts-list.h
   ...
   while a modal sagarmatha dialog is open, otherwise we're better off
...
const MediaKeysManagerInterface = {
    name: 'org.sagarmatha.SettingsDaemon.KeybindingHandler',
    methods:
        [
