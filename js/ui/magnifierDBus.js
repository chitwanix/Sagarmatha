...
function SagarmathaMagnifier() {
    this._init();
}

SagarmathaMagnifier.prototype = {
    _init: function() {
        this._zoomers = {};
    ...
    createZoomRegion: function(xMagFactor, yMagFactor, roi, viewPort) {
        ...
        let zoomRegionProxy = new SagarmathaMagnifierZoomRegion(objectPath, realZoomRegion);
    ...
    getZoomRegions: function() {
        ...
        zoomRegions.forEach (function(aZoomRegion, index, array) {
            ...
            if (!found) {
                ...
                _zoomRegionInstanceCount++;
                let zoomRegionProxy = new SagarmathaMagnifierZoomRegion(newPath, aZoomRegion);
                let proxyAndZoomer = {};
...
/**
 * SagarmathaMagnifierZoomRegion:
 * Object that implements the DBus ZoomRegion interface.
 * @zoomerObjectPath:   String that is the path to a DBus ZoomRegion.
 * @zoomRegion:         The actual zoom region associated with the object path.
 */
function SagarmathaMagnifierZoomRegion(zoomerObjectPath, zoomRegion) {
    this._init(zoomerObjectPath, zoomRegion);
}

SagarmathaMagnifierZoomRegion.prototype = {
...
DBus.conformExport(SagarmathaMagnifier.prototype, MagnifierIface);
DBus.conformExport(SagarmathaMagnifierZoomRegion.prototype, ZoomRegionIface);
