...
FocusGrabber.prototype = {
    ...
    grabFocus: function(actor) {
        ...
        if (global.stage_input_mode == Sagarmatha.StageInputMode.NONREACTIVE ||
            global.stage_input_mode == Sagarmatha.StageInputMode.NORMAL)
            global.set_stage_input_mode(Sagarmatha.StageInputMode.FOCUSED);
...
Notification.prototype = {
    ...
    _init: function(source, title, banner, params) {
        ...
        // use Sagarmatha.GenericContainer.
        this._bannerBox = new Sagarmatha.GenericContainer();
