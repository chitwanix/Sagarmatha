...
_provider.prototype = {
        _init: function (xlet, uuid, instanceId, type, string) {
            ...
            // Set up working settings file as ~/.sagarmatha/applet_config/<uuid>/<instanceid>.json
        ...
        _create_settings_file: function () {
            ...
            let init_file_contents = Sagarmatha.get_file_contents_utf8_sync(orig_file.get_path());
        ...
        _maybe_update_settings_file: function () {
            ...
            let existing_settings_file = Sagarmatha.get_file_contents_utf8_sync(this.settings_file.get_path());
            let existing_json;
	    let new_json;
            try {             
...
SettingObj.prototype = {
    _init: function (provider, file, uuid, instanceId) {
        ...
        this.uuid = uuid;
        this.instanceId = instanceId;
        let raw_file = Sagarmatha.get_file_contents_utf8_sync(this.file.get_path());
