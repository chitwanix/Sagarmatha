...
Expo.prototype = {
    ...
    _relayout: function () {
        ...
        if (this._addWorkspaceButton.get_theme_node().get_background_image() == null)
            this._addWorkspaceButton.set_style('background-image: url("/usr/share/sagarmatha/theme/add-workspace.png");'); 
    ...
    _syncInputMode: function() {
        ...
        if (this._shown) {
            ...
            else if (global.stage_input_mode == Sagarmatha.StageInputMode.FULLSCREEN)
