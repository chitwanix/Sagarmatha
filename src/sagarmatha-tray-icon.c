...
struct _SagarmathaTrayIconPrivate
{
  NaTrayChild *socket;
...
sagarmatha_tray_icon_finalize (GObject *object)
{
  ...
  G_OBJECT_CLASS (sagarmatha_tray_icon_parent_class)->finalize (object);
}
...
sagarmatha_tray_icon_constructed (GObject *object)
{
   ...
   * because Sagarmatha may want to see their values from a
...
static void
sagarmatha_tray_icon_get_property (GObject         *object,
                              guint            prop_id,
                              GValue          *value,
                              GParamSpec      *pspec)
{
...
static void
sagarmatha_tray_icon_class_init (SagarmathaTrayIconClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  g_type_class_add_private (klass, sizeof (SagarmathaTrayIconPrivate));

  object_class->get_property = sagarmatha_tray_icon_get_property;
  object_class->constructed  = sagarmatha_tray_icon_constructed;
  object_class->finalize     = sagarmatha_tray_icon_finalize;
...
/**
 * sagarmatha_tray_icon_click:
 * @icon: a #SagarmathaTrayIcon
 ...
 */
void
sagarmatha_tray_icon_click (SagarmathaTrayIcon *icon,
                       ClutterEvent  *event)
{
