...
/* Very simple test of the SagarmathaRecorder class; shows some text strings
 * moving around and records it.
 */
static SagarmathaRecorder *recorder;
...
int main (int argc, char **argv)
{
  ...
  recorder = sagarmatha_recorder_new (CLUTTER_STAGE (stage));
  sagarmatha_recorder_set_filename (recorder, "test-recorder.ogg");

  clutter_actor_show (stage);

  sagarmatha_recorder_record (recorder);
  clutter_main ();
