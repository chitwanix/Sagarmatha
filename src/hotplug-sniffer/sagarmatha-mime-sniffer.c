...
#include "sagarmatha-mime-sniffer.h"
...
G_DEFINE_TYPE (SagarmathaMimeSniffer, sagarmatha_mime_sniffer, G_TYPE_OBJECT);
...
struct _SagarmathaMimeSnifferPrivate {
  GFile *file;
...
{
  SagarmathaMimeSniffer *self = state->self;
  GArray *results;
...
static void
deep_count_start (SagarmathaMimeSniffer *self)
{
  DeepCountState *state;
                           ...
                           gpointer user_data)
{
  GFileInfo *info;
  GError *error = NULL;
  SagarmathaMimeSniffer *self = user_data;
...
static void
start_loading_file (SagarmathaMimeSniffer *self)
{
...
static void
sagarmatha_mime_sniffer_set_file (SagarmathaMimeSniffer *self,
                            GFile *file)
{
...
sagarmatha_mime_sniffer_dispose (GObject *object)
{
  ...
  G_OBJECT_CLASS (sagarmatha_mime_sniffer_parent_class)->dispose (object);
}
...
sagarmatha_mime_sniffer_finalize (GObject *object)
{
  ...
  G_OBJECT_CLASS (sagarmatha_mime_sniffer_parent_class)->finalize (object);
}

static void
sagarmatha_mime_sniffer_get_property (GObject *object,
                                guint       prop_id,
                                GValue     *value,
                                GParamSpec *pspec)
{
...
static void
sagarmatha_mime_sniffer_set_property (GObject *object,
                                guint       prop_id,
                                const GValue *value,
                                GParamSpec *pspec)
{
  ...
  switch (prop_id) {
  case PROP_FILE:
    sagarmatha_mime_sniffer_set_file (self, g_value_get_object (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
    break;
...
static void
sagarmatha_mime_sniffer_class_init (SagarmathaMimeSnifferClass *klass)
{
  GObjectClass *oclass;

  oclass = G_OBJECT_CLASS (klass);
  oclass->dispose = sagarmatha_mime_sniffer_dispose;
  oclass->finalize = sagarmatha_mime_sniffer_finalize;
  oclass->get_property = sagarmatha_mime_sniffer_get_property;
  oclass->set_property = sagarmatha_mime_sniffer_set_property;
  ...
  g_type_class_add_private (klass, sizeof (SagarmathaMimeSnifferPrivate));
  g_object_class_install_properties (oclass, NUM_PROPERTIES, properties);
}

static void
sagarmatha_mime_sniffer_init (SagarmathaMimeSniffer *self)
{
  self->priv =
...
void
sagarmatha_mime_sniffer_sniff_async (SagarmathaMimeSniffer *self,
                                ...
                                gpointer user_data)
{
  ...
  self->priv->async_result = 
    g_simple_async_result_new (G_OBJECT (self),
                               callback, user_data,
                               sagarmatha_mime_sniffer_sniff_finish);
...
gchar **
sagarmatha_mime_sniffer_sniff_finish (SagarmathaMimeSniffer *self,
                                 GAsyncResult *res,
                                 GError **error)
{
