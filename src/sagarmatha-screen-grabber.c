...
struct _SagarmathaScreenGrabberClass
{
  GObjectClass parent_class;
};

struct _SagarmathaScreenGrabber
{
...
G_DEFINE_TYPE(SagarmathaScreenGrabber, sagarmatha_screen_grabber, G_TYPE_OBJECT);
...
static void
sagarmatha_screen_grabber_class_init (SagarmathaScreenGrabberClass *grabber_class)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (grabber_class);

  gobject_class->finalize = sagarmatha_screen_grabber_finalize;
}

static void
sagarmatha_screen_grabber_init (SagarmathaScreenGrabber *grabber)
{
...
/**
 * sagarmatha_screen_grabber_grab:
 ...
 **/
guchar *
sagarmatha_screen_grabber_grab (SagarmathaScreenGrabber *grabber,
                           int                 x,
                           int                 y,
                           int                 width,
                           int                 height)
