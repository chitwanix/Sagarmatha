...
/* sagarmatha-perf-helper: a program to create windows for performance tests
 *
...
#define BUS_NAME "org.Sagarmatha.PerfHelper"
...
static const gchar introspection_xml[] =
	  "<node>"
	  "  <interface name='org.Sagarmatha.PerfHelper'>"
	  "    <method name='Exit'/>"
...
main (int argc, char **argv)
{
  ...
  /* Since we depend on this, avoid the possibility of lt-sagarmatha-perf-helper */
  g_set_prgname ("sagarmatha-perf-helper");
