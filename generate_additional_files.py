...
generate("files/usr/share/applications/sagarmatha-settings.desktop", prefix, _("System Settings"), _("Control Center"), "")

prefix = """[Desktop Entry]
Exec=sagarmatha-settings-users
Icon=system-users
Terminal=false
Type=Application
...
generate("files/usr/share/applications/sagarmatha-settings-users.desktop", prefix, _("Users and Groups"), _("Add or remove users and groups"), "")
